...
text_button::text_button(string text, int text_color, t_vect coord, t_vect size, t_color color, void(&p_fonct)())
{
	this->text = text;
...
text_button::text_button(string text, int text_color, t_vect coord, t_vect size, t_color color, t_color color2, void(&p_fonct)())
{
	this->text = text;
	this->text_color = text_color;
	this->text_size = -1;
...
text_button::text_button(string text, int text_color, int text_size, t_vect coord, t_vect size, t_color color, void(&p_fonct)())
{
	this->text = text;
	this->text_color = text_color;
...
text_button::text_button(string text, int text_color, int text_size, t_vect coord, t_vect size, t_color color, t_color color2, void(&p_fonct)())
{
	this->text = text;
	this->text_color = text_color;
	this->text_size = text_size;
...
{
	draw_border_rectangle(this->coord, this->size, this->color_front, this->color_back, 8);
	if (this->text_size != -1)
